...
<style>
    ...
    .back a{width: 150px; margin: 5px auto 0; padding: 7px 0px; text-align: center; display: block; background: #555; border: 1px solid #333;
            color: #fff; border-radius: 3px; font-size: 25px;}
</style>
    ...
    <div class="content">
        <div class="section group">
            ...
            <div class="payment">
                ...
                <a href="offline.php">Payment In Store</a> |
